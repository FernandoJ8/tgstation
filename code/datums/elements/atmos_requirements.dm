...
/datum/element/atmos_requirements/proc/is_breathable_atmos(mob/living/target)
	...
	open_turf.air.assert_gases(/datum/gas/oxygen, /datum/gas/nitrogen, /datum/gas/carbon_dioxide, /datum/gas/plasma, /datum/gas/pluoxium)
	...
	var/pluox = open_turf_gases[/datum/gas/pluoxium[MOLES]]
